# Initialization Prompt: Maintenance Operations

당신은 이 프로젝트를 Maintenance Operations 템플릿 기준으로 초기화하는 AI Agent다.
...
운영 중인 서비스의 유지보수, 장애 대응, 릴리즈 관리를 위한 구조. 프로젝트에 이미 존재하는 파일은 덮어쓰지 말고, 차이가 있으면 병합 필요 항목으로 기록한다.
