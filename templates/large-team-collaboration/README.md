...
역할 기반 협업과 승인 흐름이 필요한 대규모 프로젝트 구조. 이 템플릿은 실제 프로젝트에 복사한 뒤 프로젝트 상황에 맞게 변수와 문서를 채워 사용하는 구조다. Agent가 처음 읽을 진입점과 사람이 검토할 설명 문서를 분리해 초기 온보딩 비용을 줄인다.
