...
신규 개발 프로젝트를 위한 기본 AI Agent 친화 구조. 이 템플릿은 실제 프로젝트에 복사한 뒤 프로젝트 상황에 맞게 변수와 문서를 채워 사용하는 구조다. Agent가 처음 읽을 진입점과 사람이 검토할 설명 문서를 분리해 초기 온보딩 비용을 줄인다.
