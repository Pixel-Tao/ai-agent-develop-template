# Initialization Prompt: Greenfield Basic

당신은 이 프로젝트를 Greenfield Basic 템플릿 기준으로 초기화하는 AI Agent다.
...
신규 개발 프로젝트를 위한 기본 AI Agent 친화 구조. 프로젝트에 이미 존재하는 파일은 덮어쓰지 말고, 차이가 있으면 병합 필요 항목으로 기록한다.
