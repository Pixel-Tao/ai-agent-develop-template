...
기존 코드베이스 분석과 AI Agent 투입을 위한 온보딩 구조. 이 템플릿은 실제 프로젝트에 복사한 뒤 프로젝트 상황에 맞게 변수와 문서를 채워 사용하는 구조다. Agent가 처음 읽을 진입점과 사람이 검토할 설명 문서를 분리해 초기 온보딩 비용을 줄인다.

## 언제 사용해야 하는가

- 기존 코드베이스
- 문서 부족 프로젝트
- 변경 전 영향 분석이 필요한 프로젝트
